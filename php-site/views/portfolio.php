...
<section class="relative w-full px-6 pt-12 pb-16 md:pt-16 md:pb-24 lg:px-12 overflow-hidden">
  ...
  <div class="relative mx-auto max-w-5xl text-center">
    ...
    <h1 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-medium tracking-tight mb-6">Crafted to <span class="bg-gradient-to-r from-[#ff4500] via-[#ff6b35] to-[#ff4500]/60 bg-clip-text text-transparent">Convert</span><span class="text-[#ff4500]">.</span></h1>
...
<section class="relative w-full px-6 py-8 lg:px-12">
  <div class="relative mx-auto max-w-7xl">
    <div class="flex flex-wrap items-center gap-2" id="portfolio-filters">
      <button class="portfolio-filter active px-4 py-2 rounded-full text-xs font-semibold border transition-all duration-300 bg-[#ff4500]/10 border-[#ff4500]/30 text-[#ff4500]" data-filter="all">All Work</button>
      <?php foreach ($categories as $cat) : ?>
      <button class="portfolio-filter px-4 py-2 rounded-full text-xs font-semibold border transition-all duration-300 bg-white/[0.02] border-white/[0.08] text-white/50 hover:text-white hover:border-white/20" data-filter="<?= tml_e(strtolower(str_replace([' ', '&'], ['-', ''], $cat))) ?>"><?= tml_e($cat) ?></button>
      <?php endforeach; ?>
    </div>
  </div>
</section>
  ...
  <div class="relative mx-auto max-w-6xl">
    <div class="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-6 scroll-reveal">
      <div>
        ...
        <h2 class="text-3xl sm:text-4xl md:text-5xl font-medium text-white">See it in <span class="italic text-white/90">motion</span><span class="text-[#ff4500]">.</span></h2>
      </div>
    ...
    <div class="scroll-reveal scroll-delay-1 relative rounded-2xl overflow-hidden border border-white/[0.06] group">
      <video data-src="/tml-showreel.mp4" poster="/tml-showreel-poster.jpg" autoplay muted loop playsinline class="w-full h-auto block rounded-2xl"></video>
...
<section class="relative w-full px-6 py-20 md:py-28 lg:px-12 overflow-hidden">
  ...
  <div class="relative mx-auto max-w-3xl text-center">
    <h2 class="scroll-reveal text-3xl sm:text-4xl md:text-5xl font-medium text-white mb-6">Have a Project in Mind<span class="text-[#ff4500]">?</span></h2>
