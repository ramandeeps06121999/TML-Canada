...
<section class="relative w-full px-6 pt-12 pb-16 md:pt-16 md:pb-24 lg:px-12 overflow-hidden">
  ...
  <div class="relative mx-auto max-w-5xl text-center">
    ...
    <h1 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-medium tracking-tight mb-6">Build the future of<br /><span class="italic bg-gradient-to-r from-[#ff4500] via-[#ff6b35] to-[#ff4500]/60 bg-clip-text text-transparent">marketing</span><span class="text-[#ff4500]">.</span></h1>
...
<section class="relative w-full px-6 py-20 md:py-28 lg:px-12 bg-[#080808] overflow-hidden">
  <div class="relative mx-auto max-w-7xl">
    <div class="text-center mb-16 scroll-reveal">
      ...
      <h2 class="text-3xl sm:text-4xl md:text-5xl font-medium text-white">Why TML Agency<span class="text-[#ff4500]">.</span></h2>
    </div>
...
<section id="positions" class="relative w-full px-6 py-20 md:py-28 lg:px-12 overflow-hidden">
  <div class="relative mx-auto max-w-3xl">
    <div class="text-center mb-16 scroll-reveal">
      ...
      <h2 class="text-3xl sm:text-4xl md:text-5xl font-medium text-white">Open Positions<span class="text-[#ff4500]">.</span></h2>
    </div>
    <div class="space-y-3">
