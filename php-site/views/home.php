...
$extraHead = [tml_json_ld_script($faqSchema)];
  ...
  <div class="relative max-w-7xl mx-auto">
    <div class="flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
      <div class="lg:w-1/2 scroll-reveal">
        ...
        <h2 class="text-3xl sm:text-4xl md:text-5xl font-medium text-white mb-8 leading-tight">We're not just another agency. We're the people behind the brands you remember<span class="text-[#ff4500]">.</span></h2>
      </div>
...
<section class="relative w-full h-[70vh] min-h-[500px] flex items-center justify-center overflow-hidden">
  <div class="absolute inset-0 z-0">
    <video data-src="/team-bg.mp4" poster="/team-bg-poster.webp" autoplay muted loop playsinline class="absolute inset-0 w-full h-full object-cover" style="filter: brightness(0.65);"></video>
  </div>
  ...
  <div class="relative z-10 text-center px-6 max-w-4xl scroll-reveal">
    ...
    <h2 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-medium text-white leading-tight mb-8">We Create Ads<br><span class="italic bg-gradient-to-r from-[#ff4500] via-[#ff6b35] to-[#ff4500]/60 bg-clip-text text-transparent">People Remember.</span></h2>
  ...
  <div class="max-w-7xl mx-auto">
    <div class="flex items-center justify-between mb-12 scroll-reveal">
      <div>
        ...
        <h2 class="text-3xl sm:text-4xl md:text-5xl font-medium text-white">Every service you need under one roof<span class="text-[#ff4500]">.</span></h2>
      </div>
      <span class="hidden md:inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/[0.06] text-xs text-white/30 font-medium">12 services</span>
    </div>
    <?php
    $serviceIcons = [
        ...
        'music-release' => '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M9 18V5l12-2v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="16" r="3"/></svg>',
    ];
    $idx = 0;
    foreach (tml_service_pages() as $sp) :
        $idx++;
        $icon = $serviceIcons[$sp['slug']] ?? '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>';
    ?>
  ...
  <div class="max-w-7xl mx-auto mb-10 scroll-reveal">
    <div class="flex items-center justify-between">
      <div>
        ...
        <h2 class="text-3xl sm:text-4xl md:text-5xl font-medium text-white">The tools behind the results<span class="text-[#ff4500]">.</span></h2>
      </div>
  ...
  <div class="max-w-7xl mx-auto mb-14 scroll-reveal">
    <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
      <div class="max-w-2xl">
        ...
        <h2 class="text-3xl sm:text-4xl md:text-5xl font-medium text-white leading-tight">Trusted by the <span class="italic text-white/90">best in industry</span><span class="text-[#ff4500]">.</span></h2>
...
<!-- CREATIVE WORK SHOWCASE — Card Carousel -->
<section class="py-20 md:py-28 bg-[#0a0a0a] overflow-hidden">
  <div class="max-w-7xl mx-auto px-6 lg:px-12 mb-10 scroll-reveal">
    ...
    <h2 class="text-3xl sm:text-4xl font-medium text-white leading-tight">Brands built to <span class="text-[#ff4500]">stand out</span>.</h2>
  </div>
  <!-- Carousel -->
      ...
      <div class="flex-shrink-0 w-64 md:w-72 group">
        <div class="rounded-2xl overflow-hidden border border-white/[0.06] bg-white/[0.02] hover:border-[#ff4500]/20 transition-all duration-500">
          <div class="aspect-[4/3] relative overflow-hidden">
            <img src="/media/<?= tml_e($cc[0]) ?>" alt="<?= tml_e($cc[1]) ?> — TML Agency" loading="lazy" width="600" height="450" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
  ...
  <!-- Static 4-card grid below carousel -->
  <div class="max-w-7xl mx-auto px-6 lg:px-12 mt-10">
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 scroll-reveal scroll-delay-1">
      ...
      <div class="group rounded-xl overflow-hidden border border-white/[0.06] bg-white/[0.02] hover:border-[#ff4500]/20 transition-all duration-500">
        <div class="aspect-[4/3] relative overflow-hidden">
          <img src="/media/<?= tml_e($gc[0]) ?>" alt="<?= tml_e($gc[1]) ?> by TML Agency" loading="lazy" width="600" height="450" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
  ...
  <div class="max-w-7xl mx-auto">
    <div class="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6 scroll-reveal">
      <div>
        ...
        <h2 class="text-3xl sm:text-4xl md:text-5xl font-medium text-white leading-tight">Work that speaks <span class="text-white/90">for itself</span><span class="text-[#ff4500]">.</span></h2>
      </div>
    ...
    <div class="relative rounded-xl overflow-hidden border border-white/[0.04] mb-10 group cursor-pointer hover:border-[#ff4500]/15 transition-colors duration-500 scroll-reveal">
      <video data-src="/portfolio/tml-portfolio-showreel-2025.mp4" poster="/tml-showreel-poster.jpg" autoplay muted loop playsinline class="w-full aspect-video bg-black group-hover:scale-[1.01] transition-transform duration-700"></video>
...
<section class="py-24 md:py-32 px-6 lg:px-12 bg-[#050505] overflow-hidden">
  <div class="max-w-7xl mx-auto mb-10 scroll-reveal">
    ...
    <h2 class="text-3xl sm:text-4xl md:text-5xl font-medium text-white mb-3">Brands come alive through motion<span class="text-[#ff4500]">.</span></h2>
  ...
  <div class="flex gap-4 overflow-x-auto pb-4 snap-x snap-mandatory cursor-grab" data-tml-video-scroll style="-webkit-overflow-scrolling: touch; scrollbar-width: none;">
    ...
    <div class="flex-shrink-0 w-[200px] sm:w-[260px] md:w-[340px] lg:w-[400px] snap-center">
      <div class="relative rounded-2xl overflow-hidden border border-white/[0.06] aspect-[9/16] group hover:border-[#ff4500]/20 transition-all duration-500">
        <video data-src="<?= tml_e($reel[0]) ?>" poster="<?= tml_e($reel[1]) ?>" autoplay muted loop playsinline class="absolute inset-0 w-full h-full object-cover"></video>
...
<section class="py-24 md:py-32 px-6 lg:px-12 bg-[#080808] overflow-hidden">
  <div class="max-w-7xl mx-auto">
    <div class="mb-16 scroll-reveal">
      ...
      <h2 class="text-3xl sm:text-4xl md:text-5xl font-medium text-white">How we turn ideas into outcomes<span class="text-[#ff4500]">.</span></h2>
    </div>
    <div class="relative">
...
<section class="py-24 md:py-32 px-6 lg:px-12 bg-[#050505] overflow-hidden">
  <div class="max-w-7xl mx-auto">
    <div class="text-center mb-16 scroll-reveal">
      ...
      <h2 class="text-3xl sm:text-4xl md:text-5xl font-medium text-white mb-3">Not the Same Plan for Every <span class="italic bg-gradient-to-r from-[#ff4500] via-[#ff6b35] to-[#ff4500]/60 bg-clip-text text-transparent">Campaign</span><span class="text-[#ff4500]">.</span></h2>
...
<section class="py-24 md:py-32 px-6 lg:px-12 bg-[#080808] overflow-hidden">
  <div class="max-w-7xl mx-auto">
    <div class="text-center mb-16 scroll-reveal">
      ...
      <h2 class="text-3xl sm:text-4xl md:text-5xl font-medium text-white mb-4">Don't take our word for it. Take theirs<span class="text-[#ff4500]">.</span></h2>
...
<section class="py-24 md:py-32 px-6 lg:px-12 bg-[#050505] overflow-hidden">
  <div class="max-w-3xl mx-auto">
    <div class="text-center mb-12 scroll-reveal">
      ...
      <h2 class="text-3xl sm:text-4xl md:text-5xl font-medium text-white">Questions &amp; answers<span class="text-[#ff4500]">.</span></h2>
    </div>
    <div class="space-y-3">
...
<section class="py-24 md:py-32 px-6 lg:px-12 bg-[#050505] overflow-hidden relative">
  ...
  <div class="max-w-7xl mx-auto">
    ...
    <div class="text-center mb-12 scroll-reveal">
      ...
      <h2 class="text-3xl sm:text-4xl md:text-5xl font-medium text-white mb-2">TML Branding Agency</h2>
    ...
    <div class="relative rounded-2xl overflow-hidden border border-white/[0.06] mb-20 group scroll-reveal scroll-delay-1">
      <video data-src="/tml-showreel.mp4" poster="/tml-showreel-poster.jpg" autoplay muted loop playsinline class="w-full aspect-video bg-black"></video>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
      ...
      <div class="scroll-reveal scroll-delay-3">
        <h2 class="text-3xl sm:text-4xl md:text-5xl font-medium text-white mb-4 leading-tight">Say Hi,<br><span class="italic bg-gradient-to-r from-[#ff4500] via-[#ff6b35] to-[#ff4500]/60 bg-clip-text text-transparent">Don't Be Shy.</span></h2>
