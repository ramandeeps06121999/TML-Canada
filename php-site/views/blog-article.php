...
<article class="px-6 pt-28 md:pt-32 lg:px-12 max-w-3xl mx-auto pb-20">
  ...
  <header class="mb-10">
    ...
    <p class="text-sm text-white/35"><?= tml_e($article['date']) ?> · <?= tml_e($article['readTime']) ?></p>
  </header>
  <?php
  ...
  <div class="mb-10 rounded-2xl overflow-hidden border border-white/[0.06]">
    <img src="<?= tml_e($imageUrl) ?>" alt="" class="w-full h-auto object-cover" width="1200" height="630" loading="lazy" />
  </div>
  <?php elseif ($imageUrl !== '') : ?>
  <?php
