...
<section class="relative w-full px-6 pt-12 pb-16 md:pt-16 md:pb-20 lg:px-12 overflow-hidden">
  ...
  <div class="relative mx-auto max-w-5xl text-center">
    ...
    <h1 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-medium tracking-tight mb-6">Let&rsquo;s Build Something <span class="bg-gradient-to-r from-[#ff4500] via-[#ff6b35] to-[#ff4500]/60 bg-clip-text text-transparent">Great Together</span><span class="text-[#ff4500]">.</span></h1>
...
<section class="py-16 md:py-24 px-6 lg:px-12 overflow-hidden">
  <div class="max-w-3xl mx-auto">
    <div class="text-center mb-12 scroll-reveal">
      ...
      <h2 class="text-3xl sm:text-4xl md:text-5xl font-medium text-white">Contact questions<span class="text-[#ff4500]">.</span></h2>
    </div>
    <div class="space-y-3">
...
<section class="relative w-full px-6 py-20 md:py-28 lg:px-12 overflow-hidden">
  ...
  <div class="relative mx-auto max-w-3xl text-center scroll-reveal">
    <h2 class="text-3xl sm:text-4xl md:text-5xl font-medium text-white mb-6">Prefer to talk<span class="text-[#ff4500]">?</span></h2>
