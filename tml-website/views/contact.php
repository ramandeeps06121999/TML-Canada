<?php
$title = 'Contact TML Agency | Get a Free Consultation | Edmonton';
$description = 'Get in touch with TML Agency. Free consultation for branding, SEO, Google Ads, social media & web development.';
$keywords = 'contact TML Agency, free consultation Edmonton, digital marketing quote, SEO consultation Edmonton, branding consultation Canada, marketing agency contact';
...
$contactFaqs = [
    ...
    ['q' => 'Do you work with clients outside India?', 'a' => 'Absolutely. We serve clients across the US, Canada, UK, Australia, New Zealand, and the UAE. Our international number is +1 403 604 8692, and we schedule calls across time zones to ensure seamless communication.'],
];
...
<section class="relative w-full px-6 pt-12 pb-16 md:pt-16 md:pb-20 lg:px-12 overflow-hidden">
  ...
  <div class="relative mx-auto max-w-5xl text-center">
    ...
    <h1 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-medium tracking-tight mb-6">Contact Our <span class="bg-gradient-to-r from-[#ff4500] via-[#ff6b35] to-[#ff4500]/60 bg-clip-text text-transparent">Marketing Experts</span><span class="text-[#ff4500]">.</span></h1>
...
<section class="relative w-full px-6 pb-16 lg:px-12">
  <div class="relative mx-auto max-w-7xl">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 scroll-reveal">
      <!-- Edmonton Office -->
      <div class="glass-card rounded-2xl p-6 md:p-8 group hover:border-[#ff4500]/20 transition-colors">
        ...
        <h3 class="text-base font-semibold text-white mb-2">Edmonton Office</h3>
        <p class="text-sm text-white/45 leading-relaxed">11930 104 St NW, Edmonton, AB T5G 2K1, Canada</p>
      </div>
      <!-- Phone -->
      <a href="tel:+14036048692" class="glass-card rounded-2xl p-6 md:p-8 group hover:border-[#ff4500]/20 transition-colors block">
        <div class="w-12 h-12 rounded-xl bg-[#ff4500]/10 flex items-center justify-center mb-5 group-hover:bg-[#ff4500]/20 transition-colors">
        ...
        <h3 class="text-base font-semibold text-white mb-2">Phone</h3>
        <p class="text-sm text-white/45 group-hover:text-[#ff4500] transition-colors">+1 (403) 604-8692</p>
      </a>
      <!-- Email -->
      <a href="mailto:info@townmedialabs.ca" class="glass-card rounded-2xl p-6 md:p-8 group hover:border-[#ff4500]/20 transition-colors block">
        <div class="w-12 h-12 rounded-xl bg-[#ff4500]/10 flex items-center justify-center mb-5 group-hover:bg-[#ff4500]/20 transition-colors">
        ...
        <h3 class="text-base font-semibold text-white mb-2">Email</h3>
        <p class="text-sm text-white/45 group-hover:text-[#ff4500] transition-colors">info@townmedialabs.ca</p>
      </a>
      <!-- WhatsApp Live Chat -->
      <a href="https://wa.me/14036048692?text=Hi%20TML%20Agency%2C%20I%27d%20like%20to%20discuss%20a%20project" target="_blank" rel="noopener" class="glass-card rounded-2xl p-6 md:p-8 group hover:border-[#25D366]/20 transition-colors block">
        <div class="w-12 h-12 rounded-xl bg-[#25D366]/10 flex items-center justify-center mb-5 group-hover:bg-[#25D366]/20 transition-colors">
        ...
        <p class="text-sm text-white/45 group-hover:text-[#25D366] transition-colors">Chat on WhatsApp</p>
      </a>
    </div>
  </div>
</section>
  ...
  <div class="relative mx-auto max-w-7xl">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
      ...
      <div class="lg:col-span-2 scroll-reveal scroll-delay-1">
        <form id="tml-contact-form" class="glass-card rounded-2xl p-6 md:p-10 space-y-6">
          ...
          <div id="tml-form-success" class="hidden">
            <div class="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p class="text-sm text-white/45">We'll get back to you within 2-4 business hours.</p>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input type="text" id="contact-name" name="name" required placeholder="Your full name" class="w-full px-4 py-3 rounded-xl bg-white/[0.04] border border-white/[0.08] text-sm text-white placeholder-white/25 focus:border-[#ff4500]/40 focus:outline-none focus:ring-1 focus:ring-[#ff4500]/20 transition-colors" />
            </div>
            <!-- Email -->
            <div>
              ...
              <input type="email" id="contact-email" name="email" required placeholder="you@company.com" class="w-full px-4 py-3 rounded-xl bg-white/[0.04] border border-white/[0.08] text-sm text-white placeholder-white/25 focus:border-[#ff4500]/40 focus:outline-none focus:ring-1 focus:ring-[#ff4500]/20 transition-colors" />
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input type="tel" id="contact-phone" name="phone" placeholder="+1 (403) XXX-XXXX" class="w-full px-4 py-3 rounded-xl bg-white/[0.04] border border-white/[0.08] text-sm text-white placeholder-white/25 focus:border-[#ff4500]/40 focus:outline-none focus:ring-1 focus:ring-[#ff4500]/20 transition-colors" />
            </div>
            <!-- Service -->
            <div>
          ...
          <div class="flex items-center justify-between gap-4 pt-2">
            ...
            <button type="submit" id="tml-submit-btn" class="glow-button active:scale-[0.97] transition-transform px-8 py-4 rounded-full bg-[#ff4500] text-white font-semibold text-sm hover:bg-[#ff5500] shadow-[0_0_30px_rgba(255,69,0,0.3)] whitespace-nowrap">
              Send Message
            </button>
          </div>
          </div><!-- /tml-form-fields -->
      ...
      <div class="space-y-6 scroll-reveal scroll-delay-2">
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8">
          ...
          <h3 class="text-base font-semibold text-white mb-4">Office Hours</h3>
          <ul class="space-y-3 text-sm">
            <li class="flex items-center justify-between">
              <span class="text-white/45">Monday - Friday</span>
              <span class="text-white/70 font-medium">10:00 AM - 7:00 PM</span>
            </li>
            <li class="flex items-center justify-between">
              <span class="text-white/45">Saturday</span>
              <span class="text-white/70 font-medium">10:00 AM - 5:00 PM</span>
            </li>
            <li class="flex items-center justify-between">
              <span class="text-white/45">Sunday</span>
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8">
          ...
          <h3 class="text-base font-semibold text-white mb-2">Quick Response</h3>
          <p class="text-sm text-white/45 leading-relaxed">We typically respond within <strong class="text-white/70 font-semibold">2-4 business hours</strong>. For urgent matters, call us directly.</p>
        </div>

        <!-- Social Links -->
        <div class="glass-card rounded-2xl p-6 md:p-8">
          <h3 class="text-base font-semibold text-white mb-4">Follow Us</h3>
          <div class="flex items-center gap-3">
            <a href="#" class="w-10 h-10 rounded-xl bg-white/[0.04] border border-white/[0.08] flex items-center justify-center text-white/40 hover:text-[#ff4500] hover:border-[#ff4500]/30 transition-colors" aria-label="Instagram">
            ...
            <a href="#" class="w-10 h-10 rounded-xl bg-white/[0.04] border border-white/[0.08] flex items-center justify-center text-white/40 hover:text-[#ff4500] hover:border-[#ff4500]/30 transition-colors" aria-label="Facebook">
            ...
            <a href="#" class="w-10 h-10 rounded-xl bg-white/[0.04] border border-white/[0.08] flex items-center justify-center text-white/40 hover:text-[#ff4500] hover:border-[#ff4500]/30 transition-colors" aria-label="LinkedIn">
            ...
            <a href="#" class="w-10 h-10 rounded-xl bg-white/[0.04] border border-white/[0.08] flex items-center justify-center text-white/40 hover:text-[#ff4500] hover:border-[#ff4500]/30 transition-colors" aria-label="X (Twitter)">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            </a>
            <a href="#" class="w-10 h-10 rounded-xl bg-white/[0.04] border border-white/[0.08] flex items-center justify-center text-white/40 hover:text-[#ff4500] hover:border-[#ff4500]/30 transition-colors" aria-label="YouTube">
...
<section class="py-16 md:py-24 px-6 lg:px-12 overflow-hidden">
  <div class="max-w-3xl mx-auto">
    <div class="text-center mb-12 scroll-reveal">
      ...
      <h2 class="text-3xl sm:text-4xl md:text-5xl font-medium text-white">Contact Us &mdash; Frequently Asked Questions<span class="text-[#ff4500]">.</span></h2>
    </div>
    <div class="space-y-3">
...
<section class="relative w-full px-6 py-20 md:py-28 lg:px-12 overflow-hidden">
  ...
  <div class="relative mx-auto max-w-3xl text-center scroll-reveal">
    <h2 class="text-3xl sm:text-4xl md:text-5xl font-medium text-white mb-6">Schedule a Free Consultation Call<span class="text-[#ff4500]">.</span></h2>
    <p class="text-sm md:text-base text-white/45 leading-relaxed mb-10 max-w-xl mx-auto">Skip the form. Call us directly and speak with a strategist who can help you right away.</p>
