...
$canonicalUrl = "https://townmedialabs.ca/services/seo-in-edmonton/";
$author = "Raman Makkar";
...
$localBusinessSchema = [
    ...
    "url" => $businessUrl . "/services/seo-in-edmonton/",
    "telephone" => $businessPhone,
    "email" => $businessEmail,
    "address" => [
        "@type" => "PostalAddress",
...
$breadcrumbSchema = [
    ...
    "itemListElement" => [
        ...
        [
            ...
            "item" => $businessUrl . "/services/seo-in-edmonton/"
        ]
    ]
];
...
<head>
    ...
    <title>Best SEO in Edmonton | TML Agency | SEO Experts</title>
